...
const CYPRESS_COVERAGE = '_cypress-coverage';
const JEST_COVERAGE = '_jest-coverage';
const REPORTS_FOLDER = '_reports';
...
run([
  ...
  `yarn nyc merge ${REPORTS_FOLDER} && mv coverage.json .nyc_output/out.json`,
